...
def add_retest(project: Project) -> None:
    ...
    last_config.config.version_description = "Retest"

    project.config_new.add_version_config(version=retest_version, config=last_config.config).save()
    ...
    for target in project.config_new.at_version(last_version).config.targets:
