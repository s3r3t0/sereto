...
def render_sow_cleanup(settings: Settings, version: ReportVersion) -> None:
...
def render_report_cleanup(settings: Settings, version: ReportVersion) -> None:
...
def render_target_cleanup(target: Target, settings: Settings) -> None:
...
def render_finding_group_cleanup(finding_group: FindingGroup, target: Target, settings: Settings) -> None:
